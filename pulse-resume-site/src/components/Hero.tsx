...
const Hero = () => {
  const handleDownloadResume = () => {
    ...
    link.href = '/lovable-uploads/7beeb74a-1a72-4290-91b4-069abc9cfa5f.png';
    link.download = 'Dhanachandru_R_Resume.pdf';
  ...
  const handleViewResume = () => {
    ...
    window.open('/lovable-uploads/7beeb74a-1a72-4290-91b4-069abc9cfa5f.png', '_blank');
  };
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-4 sm:px-6">
        <div className="animate-fade-in">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-bold mb-4 md:mb-6 leading-tight">
            <span className="text-gradient">DHANACHANDRU.R</span>
          </h1>
          
          <div className="text-lg sm:text-xl md:text-2xl lg:text-4xl font-light mb-6 md:mb-8 h-auto md:h-16">
            <span className="typewriter inline-block">Computer Science Student & Future Software Engineer</span>
          </div>
